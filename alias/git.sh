...
git config --global alias.m2b '!git checkout master && git fetch && git pull && git branch perseusbranch && git checkout && git checkout perseusbranch'
git config --global alias.pr2m '!git push origin perseusbranch && pullRequest'